...
namespace EPharmacy.Data.Migrations
{
    ...
    [Migration("20190519212231_AddImageUrlToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.ApplicationUserRole", b =>
                {
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.Products.Product", b =>
                {
                    ...
                    b.Property<string>("ImageUrl")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue("https://ziwgstorage.blob.core.windows.net/product-images/eb6d1046-ce98-49f1-bff7-c6deb2ee14d7diohespan_max.jpg");
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.ApplicationUserRole", b =>
                {
                    b.HasOne("EPharmacy.Data.Entities.ApplicationRole")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("EPharmacy.Data.Entities.ApplicationRole", "Role")
                        .WithMany("RoleUsers")
                        .HasForeignKey("RoleId1");

                    b.HasOne("EPharmacy.Data.Entities.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("EPharmacy.Data.Entities.ApplicationUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("EPharmacy.Data.Entities.SalesOrders.SalesOrder", b =>
                {
                    b.HasOne("EPharmacy.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
